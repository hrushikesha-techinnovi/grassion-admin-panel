...
// const toggle = () => setIsOpen(!isOpen);
  return (
    ...
    <Sidebar className='shadow-sm h-100'>
    <div className="d-flex justify-content-between align-items-center p-2">
      ...
      <Menu iconShape="square" className="fst-normal">
        <SubMenu label="Tips" icon={<MdOutlineTipsAndUpdates />}>
          <Link to="/"><MenuItem>Add tip</MenuItem></Link>
          <Link to="/tiplist"><MenuItem>Tip List</MenuItem></Link>
        </SubMenu>
        <SubMenu label="Events" icon={<MdEventAvailable />}>
        <Link to="/addevent"><MenuItem>Add Event</MenuItem></Link>
        <Link to="/eventlist"><MenuItem>Event List</MenuItem></Link>
        </SubMenu>
      </Menu>
    </Sidebar>
    </div>
